# nvim-treesitter-queries-pony

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-pony/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-pony/actions/workflows/validate.yml)

Neovim tree-sitter queries for **pony**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-pony",
...
- [ ] Changes are scoped to `pony` — do not include files for other languages
